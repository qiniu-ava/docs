- [AVA 整体实施方案](#ava-%E6%95%B4%E4%BD%93%E5%AE%9E%E6%96%BD%E6%96%B9%E6%A1%88)
  ...
  - [安装部署](#%E5%AE%89%E8%A3%85%E9%83%A8%E7%BD%B2)
    ...
    - [(五) 部署 calico](#%E4%BA%94-%E9%83%A8%E7%BD%B2-calico)
    - [(六) 部署 kubernetes](#%E5%85%AD-%E9%83%A8%E7%BD%B2-kubernetes)
    - [(七) 部署 AVA 服务](#%E4%B8%83-%E9%83%A8%E7%BD%B2-ava-%E6%9C%8D%E5%8A%A1)
...
* 纯储存节点，用于部署 ceph monitor 与 ceph OSD，视实际容量需求决定节点数量
  * CPU 36 cores
  * memory 128Gi 起(内存与 SSD 数量成正比，每块 SSD 对应 8~10Gi)
  * 240Gi SSD + 2T 或 4T SSD * 12 起(建议全部使用 SSD 资源)
  * 至少1张万兆网卡
...
经过讨论，此集群规模能控制在 256 个节点以内。上述规划的服务器节点最好都使用 2U 的机箱，IDC 规划时请预留一些机柜资源。建议将所有在此系统中的节点都规划在同一机房，并使用同一网段管理，以有效降低网络链路对存储访问的影响。
...
可使用 ceph-deploy 项目在需要部署 ceph OSD 和 ceph MDS 等服务的节点上安装部署各 ceph 服务。

使用其他对象存储服务

### (四) 搭建缓存系统

可以基于 ceph 或者七牛对象存储系统搭建 Alluxio 缓存系统。
...
* 使用 kubeadm 分别部署 kubernetes master/dns/node 等节点上所需的服务
...
* 调度到 GPU 节点上时，优先选择能够满足申请资源且剩余资源最少的节点
